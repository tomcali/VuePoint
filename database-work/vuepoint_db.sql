...
CREATE TABLE `books` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `title` VARCHAR(255), `version` VARCHAR(255), `description` VARCHAR(255), `pagecnt` INTEGER, `ISBN10` INTEGER, `ISBN13` INTEGER, `price` INTEGER, `coverart` TEXT, `aboutcover` TEXT, `outofprint` TEXT, `role` TEXT, `author_editor1` TEXT, `author_editor2` TEXT, `author_editor3` TEXT, `author_editor4` TEXT, `author_editor5` TEXT, `author_editor6` TEXT, `artist1` TEXT, `artist2` TEXT, `artist3` TEXT, `artist4` TEXT, `createdAt` DATETIME NOT NULL, `updatedAt` DATETIME NOT NULL);
INSERT INTO `books` VALUES (1,'Without a Tout: How to Pick a Winning Team','Print','Without a Tout is a practical, no-nonsense guide to building models for team sports. Making predictive models accessible to the nontechnical reader, the book describes a class of handicapping methods based upon careful analysis of sports data and thorough testing of model performance.

There is recreational betting. This can be fun. There is betting out of necessity or perceived necessity, induced perhaps by poverty or addiction. This is sad. And there is rational betting, betting when it makes sense to do so. This is a test of wit. Without a Tout is about betting when it makes sense to do so, when the odds are in our favor. ',140,'097272978X',9780972729789,3000,'wat_cover.gif','','','Author','Thomas W. Miller',NULL,NULL,NULL,NULL,NULL,'Anthony L. Hamelink','Jane Tenenbaum',NULL,NULL,'2017-05-17 04:39:55.517 +00:00','2017-05-17 04:39:55.517 +00:00');
INSERT INTO `books` VALUES (2,'Without a Tout: How to Pick a Winning Team','Electronic','Without a Tout is a practical, no-nonsense guide to building models for team sports. Making predictive models accessible to the nontechnical reader, the book describes a class of handicapping methods based upon careful analysis of sports data and thorough testing of model performance.

There is recreational betting. This can be fun. There is betting out of necessity or perceived necessity, induced perhaps by poverty or addiction. This is sad. And there is rational betting, betting when it makes sense to do so. This is a test of wit. Without a Tout is about betting when it makes sense to do so, when the odds are in our favor. ',140,1601472005,9781601472007,2400,'wat_cover.gif',NULL,'','Author','Thomas W. Miller',NULL,NULL,NULL,NULL,NULL,'Anthony L. Hamelink','Jane Tenenbaum',NULL,NULL,'2017-05-17 04:41:55.514 +00:00','2017-05-17 04:41:55.514 +00:00');
INSERT INTO `books` VALUES (3,'Getting Started with Conjoint Analysis: Strategies for Product Design and Pricing Research','Print','Ask people what they want, and they say, “the best of everything.”  Ask them what they would like to spend, and they say, “as little as possible.”  Assessing consumer preferences and willingness to pay through direct rating scales, with separate questions about product features and prices, often fails to capture the tradeoffs that underlie consumer choice.
...
With new chapters about adaptive choice-based conjoint and maximum difference scaling and additional examples of business applications, the second edition of Getting Started with Conjoint Analysis continues to provide an excellent introduction to conjoint and choice methods.',252,'',9780972729772,4000,'gsca2_cover2ed.jpg','The cover artwork for Getting Started with Conjoint Analysis, entitled Mask of Fear, is by Paul Klee (1879-1940): Maske Furcht, 1932, 286 (Y 6) 100 x 57 cm Ölfarbe auf Jute auf Keilrahmen, The Museum of Modern Art, New York.
...
INSERT INTO `books` VALUES (4,'Getting Started with Conjoint Analysis: Strategies for Product Design and Pricing Research','Electronic','Ask people what they want, and they say, “the best of everything.”  Ask them what they would like to spend, and they say, “as little as possible.”  Assessing consumer preferences and willingness to pay through direct rating scales, with separate questions about product features and prices, often fails to capture the tradeoffs that underlie consumer choice.

Conjoint analysis goes beyond simple surveys, providing a more realistic approach to understanding consumer attitudes, opinions, and behavior.  Introduced as a fundamental measurement method more than forty years ago, conjoint analysis presents combinations of features or attributes in product profiles and asks people to rank or rate those product profiles or to make choices among product profiles.

With new chapters about adaptive choice-based conjoint and maximum difference scaling and additional examples of business applications, the second edition of Getting Started with Conjoint Analysis continues to provide an excellent introduction to conjoint and choice methods.',252,'',9781601471109,3200,'gsca2_cover2ed.jpg','The cover artwork for Getting Started with Conjoint Analysis, entitled Mask of Fear, is by Paul Klee (1879-1940): Maske Furcht, 1932, 286 (Y 6) 100 x 57 cm Ölfarbe auf Jute auf Keilrahmen, The Museum of Modern Art, New York.

The cover was designed by Jane Tenenbaum of Tenenbaum Design, Cambridge, Massachusetts.

Cover artwork is consistent with the content of the book. The book deals with methodologies for consumer and business research and the choices that buyers make under an assumed utility maximization motive. When looking at the artwork, we imagine the face of a bewildered consumer, enough feet to go in many directions at once, and an arrow pointing upward out of his head (a possible symbol for utility maximization).','','Author','Bryan K. Orme',NULL,NULL,NULL,NULL,NULL,'Jane Tenenbaum',NULL,NULL,NULL,'','');
CREATE TABLE "book" (
...
INSERT INTO `book` VALUES (2,'Without a Tout: How to Pick a Winning Team','Electronic','Without a Tout is a practical, no-nonsense guide to building models for team sports. Making predictive models accessible to the nontechnical reader, the book describes a class of handicapping methods based upon careful analysis of sports data and thorough testing of model performance. ',140,'1--60147--200--5','978--1--60147--200--7',2400,'wat_cover.gif','','','Author','Thomas W. Miller',NULL,NULL,NULL,NULL,NULL,'Anthony L. Hamelink','Jane Tenenbaum',NULL,NULL);
...
A student of English and Economics at Brigham Young University, Bryan received his BA in 1991. He then earned his MBA from the University of Texas at Austin in 1993. Bryan and his wife of fifteen years, Chandra, have seven children and reside in Poulsbo, Washington.');
CREATE TABLE `artists` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `artist` VARCHAR(255), `biography` VARCHAR(255), `createdAt` DATETIME NOT NULL, `updatedAt` DATETIME NOT NULL);
INSERT INTO `artists` VALUES (1,'Anthony L. Hamelink','Windsor, Wisconsin','','');
INSERT INTO `artists` VALUES (2,'Jane Tenenbaum','Tenenbaum Design, Cambridge, Massachusetts','','');
CREATE TABLE "artist" (
	`id`	INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
